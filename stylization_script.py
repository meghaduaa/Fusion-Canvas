...
if __name__ == "__main__":
    ...
    parser.add_argument("--content_input", type=str, help="Content image(s) to stylize", default="lion.jpg")
    ...
    parser.add_argument("--model_name", type=str, help="Model binary to use for stylization", default='edtaonisl_9e5_33k.pth')
